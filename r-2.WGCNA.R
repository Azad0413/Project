...
enableWGCNAThreads()
dat_final<-read.delim2("/data/nas1/luchunlin/project/BJTC-317/00_rawdata/dat.final.xls", row.names = 1)  %>% lc.tableToNum
...
# 40 3514 1851 1336 1276 1092  587  524  489  464  440  437  366  242  220  219  149  144  143   66   43 
## 灰色的为**未分类**到模块的基因。
