...
##  19712 448
## 把检验点基因提取出来
checkpoint <- data.frame(V1=c('PDCD1','CD274','CTLA4','IDO1','CD96','TIGIT','LAG3','PVR'))
...
DE.checkpoint_dat <- t(dat.tcga[which(rownames(dat.tcga)%in%DE.checkpoint$gene),])%>%as.data.frame()
dim(checkpoint_dat)
...
checkpoint_cor1
ggsave(filename = "02.PVR_riskscore_cor.png", height = 7, width = 8,checkpoint_cor1)
ggsave(filename = "02.PVR_riskscore_cor.pdf", height = 7, width = 8,checkpoint_cor1)
library(ggstatsplot)
checkpoint_cor2 <- ggscatterstats(data = cor_plot_dat,
        ...
        plot.title = element_text(size = 12))
checkpoint_cor2
ggsave(filename = "03.IDO1_riskscore_cor.png", height = 7, width = 8,checkpoint_cor2)
ggsave(filename = "03.IDO1_riskscore_cor.pdf", height = 7, width = 8,checkpoint_cor2)
...
checkpoint_cor3 <- ggscatterstats(data = cor_plot_dat,
        ...
        plot.title = element_text(size = 12))
checkpoint_cor3
ggsave(filename = "04.LAG3_riskscore_cor.png", height = 7, width = 8,checkpoint_cor3)
ggsave(filename = "04.LAG3_riskscore_cor.pdf", height = 7, width = 8,checkpoint_cor3)
...
checkpoint_cor5
ggsave(filename = "06.CTLA4_riskscore_cor.png", height = 7, width = 8,checkpoint_cor5)
ggsave(filename = "06.CTLA4_riskscore_cor.pdf", height = 7, width = 8,checkpoint_cor5)
...
checkpoint_cor6
ggsave(filename = "07.CD96_riskscore_cor.png", height = 7, width = 8,checkpoint_cor6)
ggsave(filename = "07.CD96_riskscore_cor.pdf", height = 7, width = 8,checkpoint_cor6)
colnames(cor_plot_dat)
library(ggstatsplot)
checkpoint_cor7 <- ggscatterstats(data = cor_plot_dat,
                                  x = riskScore,
                                  y = TIGIT,
                                  centrality.para = "mean",
                                  margins = "both",
...
checkpoint_cor7
ggsave(filename = "08.TIGIT_riskscore_cor.png", height = 7, width = 8,checkpoint_cor7)
ggsave(filename = "08.TIGIT_riskscore_cor.pdf", height = 7, width = 8,checkpoint_cor7)

library(patchwork)
all_correlation <-checkpoint_cor1+checkpoint_cor2+checkpoint_cor3+checkpoint_cor4+checkpoint_cor5+checkpoint_cor6+checkpoint_cor7+
  plot_layout(ncol = 3) &
  theme_bw() &
...
all_correlation
ggsave('09.correlation_all.pdf',all_correlation,w=19,h=15)
ggsave('09.correlation_all.png',all_correlation,w=19,h=15)
