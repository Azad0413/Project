...
if (! dir.exists("./06_validation3")){
  dir.create("./06_validation3")
}
setwd("./06_validation3")
hubgene <- read.delim2('../04_model/hubgene.xls')
#hubgene <- read.delim2('../02_DEERS/DEERS.xls')
dat<-read.delim2("../00_rawdata/dat(GSE20681).xls", row.names = 1)%>% lc.tableToNum
group = read.delim2("../00_rawdata/group(GSE20681).xls")
