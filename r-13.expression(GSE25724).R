...
if (! dir.exists("./13_expression(GSE25724)")){
  dir.create("./13_expression(GSE25724)")
}
setwd("./13_expression(GSE25724)")
...
df<-read.delim2('../03_DEGs(GSE25724)/DEG_sig(GSE25724).xls')
## 
library(tidyverse)
...
## 样本分组
hub_exp2$Group<-ifelse(hub_exp2$sample%in%control.sample,'control','T2D')
