...
phenotype<-read.delim2('/data/nas1/luchunlin/TCGA_phenotype/TCGA-STAD.GDC_phenotype.tsv.gz')
...
train_phenotype2$Stage<-gsub('stge iv','Stage4',train_phenotype2$Stage)
train_phenotype2$Stage<-gsub('stge iii','Stage3',train_phenotype2$Stage)
train_phenotype2$Stage<-gsub('stge ii','Stage2',train_phenotype2$Stage)
train_phenotype2$Stage<-gsub('stge i','Stage1',train_phenotype2$Stage)
...
risk<-read.csv('../07_risk/risk.xls',sep = '\t')
...
# ## 08-1 TNM stage-----
my_comparisons <- list(c("Stage1","Stage2"),c("Stage2","Stage3"),c("Stage3","Stage4"))
...
my_comparisons <- list(c("N0","N1"),c('N1','N2'),c('N2','N3'))
