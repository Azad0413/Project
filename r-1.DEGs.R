...
library(stringr)
library(limma)
df = read.delim2("../00_rawdata/dat(GSE113079).xls", row.names = 1) %>% lc.tableToNum
df.group = read.delim2("../00_rawdata/group(GSE113079).xls")
...
#x<-t(scale(t(heat)))
ann_colors<-list(
  group = c(control="#00CED1",CAD="#F08080"))
