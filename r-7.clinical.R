...
phenotype<-read.delim2('/data/nas1/luchunlin/project/BJTC-308/00_rawdata/phenotype.xls')
...
train_phenotype2$T.stage<-gsub('t stage: T3','T3/4',train_phenotype2$T.stage)
train_phenotype2$T.stage<-gsub('t stage: T4','T3/4',train_phenotype2$T.stage)
...
library(patchwork)
all_clinical_index <- gender+stage + T.stage + N.stage +
  plot_layout(ncol = 2) &
  theme_bw() &
