...
risk<-read.delim2('/data/nas1/luchunlin/project/BJTC-357/05_risk/risk.xls')
...
violin_plot
ggsave('checpoint.pdf',violin_plot,w=8,h=5)
ggsave('checpoint.png',violin_plot,w=8,h=5)
