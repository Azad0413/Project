...
if (! dir.exists("./08_expression")){
  dir.create("./08_expression")
}
setwd("./08_expression")

library(lance)
dat<-read.delim2('/data/nas1/luchunlin/project/LZZK-503/00_rawdata/dat.xls',row.names = 1)%>%lc.tableToNum()
group<-read.delim2('/data/nas1/luchunlin/project/LZZK-503/00_rawdata/group.xls')
