...
if (! dir.exists("./21_expression")){
  dir.create("./21_expression")
}
setwd("./21_expression")
library(tidyverse)
dat<-read.csv("../00_rawdata/dat.fpkm.xls", row.names = 1,sep = '\t')
...
exp_plot
ggsave('01.expression.pdf',exp_plot,width = 7,height = 7)
ggsave('01.expression.png',exp_plot,width = 7,height = 7)
