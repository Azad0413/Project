...
if (! dir.exists("./04_enrichment(GSE25724)")){
  dir.create("./04_enrichment(GSE25724)")
}
setwd("./04_enrichment(GSE25724)")
library(clusterProfiler)
library(org.Hs.eg.db)
library(ggplot2)
library(enrichplot)
library(GOplot)
sig.diff1 <- read.delim2('../03_DEGs(GSE25724)/DEG_sig(GSE25724).xls')
