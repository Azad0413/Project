...
library(readr)
library(tidyverse)
survival<-read_tsv(file = 'TCGA-BLCA.survival.tsv')
survival<-survival[,-3]
...
group<-read.delim2("/data/nas1/luchunlin/project/LZZK-512/01_DEGs/group.xls")
Tumor.sample<-group$sample[which(group$group=='Tumor')]
DEGRG<-read.delim2('/data/nas1/luchunlin/project/LZZK-512/02_DEGRG/DEGRG.xls')
...
train_dat<-train_dat[,colnames(train_dat)%in%DEGRG$Geneset,]
